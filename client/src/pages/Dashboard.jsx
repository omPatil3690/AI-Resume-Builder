        ...
        <div>
            <div className="max-w-7xl mx-auto px-4 py-8">
                ...
                <div className="flex gap-4">
                    <button onClick={() => setShowCreateResume(true)} className="flex-1 bg-white min-w-[280px] h-48 flex flex-col items-center justify-center rounded-lg gap-2 text-slate-600 border border-dashed border-slate-300 group hover:border-indigo-500 hover:shadow-lg transition-all duration-300 cursor-pointer">
                    ...
                    <button onClick={() => setShowUploadResume(true)} className="flex-1 bg-white min-w-[280px] h-48 flex flex-col items-center justify-center rounded-lg gap-2 text-slate-600 border border-dashed border-slate-300 group hover:border-indigo-500 hover:shadow-lg transition-all duration-300 cursor-pointer">
                        ...
                        <div onClick={e => e.stopPropagation()} className="relative bg-slate-50 border shadow-md rounded-lg w-full max-w-sm p-6">
                            ...
                            <div>
                                ...
                                >
                                    ...
                                    <div className="flex flex-col items-center justify-center gap-2 border group text-slate-400 border-slate-400 border-dashed rounded-md p-4 py-10 my-4 hover:border-orange-500 hover:text-green-700 cursor-pointer transition-colors">
                                        {resume ? (
