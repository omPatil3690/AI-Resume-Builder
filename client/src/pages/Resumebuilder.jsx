...
import { ArrowLeftIcon, Briefcase, FileText, FolderIcon, GraduationCap, Sparkles, User, ChevronLeft, ChevronRight, Share2, Eye, EyeOff, Download } from 'lucide-react';
    ...
    return (
        <div>
          ...
          rounded-lg ring-blue-300 hover:ring transition-colors">
                                    ...
                                    <button onClick={changeResumeVisibility} className="flex items-center p-2 px-4 gap-2 text-xs bg-gradient-to-br from-purple-100 to-purple-200 text-purple-600 ring-pruple-300 rounded-lg hover:ring transition-colors">
                                        {resumeData.public ? (
